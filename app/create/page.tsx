...
function Creator() {
  ...
  const [envelopeColour,setEnvelopeColour]=useState("rosewood");
  ...
  return <main className="creator-page">
    ...
    <LetterPreviewExperience open={previewOpen} onClose={()=>setPreviewOpen(false)} recipient={recipient} sender={sender} headline={headline} message={message} photos={photos} flower={flower} occasion={occasion} theme={theme} envelopeColour={envelopeColour}/>
  </main>;
}
